...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/capabilities.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/capabilities.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/</a> &#187; capabilities.js</div>
</div>
<div class="body">
 ...
 * @record
 */
<span class="fstat-no" title="function not covered" >function ProxyConfig() {</span>}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function toMap(hash) {</span>
<span class="cstat-no" title="statement not covered" >  let m = new Map;</span>
<span class="cstat-no" title="statement not covered" >  for (let key in hash) {</span>
<span class="cstat-no" title="statement not covered" >    if (hash.hasOwnProperty(key)) {</span>
<span class="cstat-no" title="statement not covered" >      m.set(key, hash[key]);</span>
    }
  }
...
class Capabilities extends Map {
   ...
   */
  constructor<span class="fstat-no" title="function not covered" >(opt_other) {</span>
<span class="cstat-no" title="statement not covered" >    if (opt_other &amp;&amp; !(opt_other instanceof Map)) {</span>
<span class="cstat-no" title="statement not covered" >      opt_other = toMap(opt_other);</span>
    }
<span class="cstat-no" title="statement not covered" >    super(opt_other);</span>
  }
&nbsp;
  /**
   * @return {!Capabilities} A basic set of capabilities for Android.
   */
  static android<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities()</span>
...
&nbsp;
   ...
   */
  static chrome<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().set(Capability.BROWSER_NAME, Browser.CHROME);</span>
  }
&nbsp;
  /**
   * @return {!Capabilities} A basic set of capabilities for Microsoft Edge.
   */
  static edge<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities()</span>
...
&nbsp;
   ...
   */
  static firefox<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().set(Capability.BROWSER_NAME, Browser.FIREFOX);</span>
  }
&nbsp;
  /**
   * @return {!Capabilities} A basic set of capabilities for Internet Explorer.
   */
  static ie<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static ipad<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static iphone<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static opera<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static phantomjs<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static safari<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static htmlunit<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
...
&nbsp;
   ...
   */
  static htmlunitwithjs<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return new Capabilities().</span>
        set(Capability.BROWSER_NAME, Browser.HTMLUNIT).
...
<span class="cstat-no" title="statement not covered" >    return serialize(this);</span>
  }
&nbsp;
  /**
   ...
   */
  merge<span class="fstat-no" title="function not covered" >(other) {</span>
<span class="cstat-no" title="statement not covered" >    if (!other) {</span>
<span class="cstat-no" title="statement not covered" >      throw new TypeError('no capabilities provided for merge');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!(other instanceof Map)) {</span>
<span class="cstat-no" title="statement not covered" >      other = toMap(other);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (let key of other.keys()) {</span>
<span class="cstat-no" title="statement not covered" >      this.set(key, other.get(key));</span>
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw new TypeError('Capability keys must be strings: ' + typeof key);</span>
    }
<span class="cstat-no" title="statement not covered" >    super.set(key, value);</span>
<span class="cstat-no" title="statement not covered" >    return this;</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return this.set(Capability.LOGGING_PREFS, prefs);</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return this.set(Capability.PROXY, proxy);</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return this.set(Capability.NATIVE_EVENTS, enabled);</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return this.set(Capability.ELEMENT_SCROLL_BEHAVIOR, behavior);</span>
  }
&nbsp;
  /**
...
<span class="cstat-no" title="statement not covered" >    return this.set(Capability.UNEXPECTED_ALERT_BEHAVIOR, behavior);</span>
  }
}
&nbsp;
&nbsp;
 ...
 *     Note, the returned object may contain nested promised values.
 */
<span class="fstat-no" title="function not covered" >function serialize(caps) {</span>
<span class="cstat-no" title="statement not covered" >  let ret = {};</span>
<span class="cstat-no" title="statement not covered" >  for (let key of caps.keys()) {</span>
<span class="cstat-no" title="statement not covered" >    let cap = caps.get(key);</span>
<span class="cstat-no" title="statement not covered" >    if (cap !== undefined &amp;&amp; cap !== null) {</span>
<span class="cstat-no" title="statement not covered" >      ret[key] = cap;</span>
    }
  }

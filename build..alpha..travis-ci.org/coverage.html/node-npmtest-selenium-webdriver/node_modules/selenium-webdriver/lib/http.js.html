...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/http.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/http.js</span></h1>
    <h2>
        
        Statements: <span class="metric">24.05% <small>(38 / 158)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">0% <small>(0 / 69)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">22.73% <small>(5 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">22.82% <small>(34 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/</a> &#187; http.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function headersToString(headers) {</span>
<span class="cstat-no" title="statement not covered" >  let ret = [];</span>
<span class="cstat-no" title="statement not covered" >  headers.forEach(<span class="fstat-no" title="function not covered" >function(value, name) {</span></span>
<span class="cstat-no" title="statement not covered" >    ret.push(`${name.toLowerCase()}: ${value}`);</span>
  });
...
class Request {
   ...
   */
  constructor<span class="fstat-no" title="function not covered" >(method, path, opt_data) {</span>
<span class="cstat-no" title="statement not covered" >    this.method = /** string */method;</span>
<span class="cstat-no" title="statement not covered" >    this.path = /** string */path;</span>
<span class="cstat-no" title="statement not covered" >    this.data = /** Object */opt_data;</span>
<span class="cstat-no" title="statement not covered" >    this.headers = /** !Map&lt;string, string&gt; */new Map(</span>
        [['Accept', 'application/json; charset=utf-8']]);
  }
&nbsp;
  /** @override */
  toString<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    let ret = `${this.method} ${this.path} HTTP/1.1\n`;</span>
<span class="cstat-no" title="statement not covered" >    ret += headersToString(this.headers) + '\n\n';</span>
<span class="cstat-no" title="statement not covered" >    if (this.data) {</span>
<span class="cstat-no" title="statement not covered" >      ret += JSON.stringify(this.data);</span>
    }
...
class Response {
   ...
   */
  constructor<span class="fstat-no" title="function not covered" >(status, headers, body) {</span>
<span class="cstat-no" title="statement not covered" >    this.status = /** number */status;</span>
<span class="cstat-no" title="statement not covered" >    this.body = /** string */body;</span>
<span class="cstat-no" title="statement not covered" >    this.headers = /** !Map&lt;string, string&gt;*/new Map;</span>
<span class="cstat-no" title="statement not covered" >    for (let header in headers) {</span>
<span class="cstat-no" title="statement not covered" >      this.headers.set(header.toLowerCase(), headers[header]);</span>
    }
  }
&nbsp;
  /** @override */
  toString<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    let ret = `HTTP/1.1 ${this.status}\n${headersToString(this.headers)}\n\n`;</span>
<span class="cstat-no" title="statement not covered" >    if (this.body) {</span>
<span class="cstat-no" title="statement not covered" >      ret += this.body;</span>
    }
<span class="cstat-no" title="statement not covered" >    return ret;</span>
  }
}
 ...
 */
<span class="fstat-no" title="function not covered" >function toExecuteAtomCommand(command, atom, ...params) {</span>
<span class="cstat-no" title="statement not covered" >  return new Promise((resolve, reject) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof atom !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >      reject(new InternalTypeError('atom is not a function: ' + typeof atom));</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    let newCmd = new cmd.Command(cmd.Name.EXECUTE_SCRIPT)</span>
        .setParameter('sessionId', command.getParameter('sessionId'))
        .setParameter('script', `return (${atom}).apply(null, arguments)`)
        .setParameter('args', params.map(param =&gt; <span class="cstat-no" title="statement not covered" >command.getParameter(param))</span>);
<span class="cstat-no" title="statement not covered" >    resolve(newCmd);</span>
  });
}
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return toExecuteAtomCommand(cmd, Atom.GET_ATTRIBUTE, 'id', 'name');</span>
  }],
...
<span class="cstat-no" title="statement not covered" >    return toExecuteAtomCommand(cmd, Atom.IS_DISPLAYED, 'id');</span>
  }],
...
&nbsp;
   ...
   *     server's response.
   */
  send<span class="fstat-no" title="function not covered" >(httpRequest) {</span>}
}
&nbsp;
&nbsp;
const CLIENTS =
 ...
 */
<span class="fstat-no" title="function not covered" >function doSend(executor, request) {</span>
<span class="cstat-no" title="statement not covered" >  const client = CLIENTS.get(executor);</span>
<span class="cstat-no" title="statement not covered" >  if (promise.isPromise(client)) {</span>
<span class="cstat-no" title="statement not covered" >    return client.then(client =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      CLIENTS.set(executor, client);</span>
<span class="cstat-no" title="statement not covered" >      return client.send(request);</span>
    });
  } else {
<span class="cstat-no" title="statement not covered" >    return client.send(request);</span>
  }
 ...
 *     command to execute.
 */
<span class="fstat-no" title="function not covered" >function buildRequest(customCommands, w3c, command) {</span>
<span class="cstat-no" title="statement not covered" >  LOG.finest(() =&gt; <span class="cstat-no" title="statement not covered" >`Translating command: ${command.getName()}`)</span>;</span>
<span class="cstat-no" title="statement not covered" >  let spec = customCommands &amp;&amp; customCommands.get(command.getName());</span>
<span class="cstat-no" title="statement not covered" >  if (spec) {</span>
<span class="cstat-no" title="statement not covered" >    return toHttpRequest(spec);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (w3c) {</span>
<span class="cstat-no" title="statement not covered" >    spec = W3C_COMMAND_MAP.get(command.getName());</span>
<span class="cstat-no" title="statement not covered" >    if (typeof spec === 'function') {</span>
<span class="cstat-no" title="statement not covered" >      LOG.finest(() =&gt; <span class="cstat-no" title="statement not covered" >`Transforming command for W3C: ${command.getName()}`)</span>;</span>
<span class="cstat-no" title="statement not covered" >      return spec(command)</span>
          .then(newCommand =&gt; <span class="cstat-no" title="statement not covered" >buildRequest(customCommands, w3c, newCommand))</span>;
    } else <span class="cstat-no" title="statement not covered" >if (spec) {</span>
<span class="cstat-no" title="statement not covered" >      return toHttpRequest(spec);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  spec = COMMAND_MAP.get(command.getName());</span>
<span class="cstat-no" title="statement not covered" >  if (spec) {</span>
<span class="cstat-no" title="statement not covered" >    return toHttpRequest(spec);</span>
  }
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function toHttpRequest(resource) {</span>
<span class="cstat-no" title="statement not covered" >    LOG.finest(() =&gt; <span class="cstat-no" title="statement not covered" >`Building HTTP request: ${JSON.stringify(resource)}`)</span>;</span>
<span class="cstat-no" title="statement not covered" >    let parameters = command.getParameters();</span>
<span class="cstat-no" title="statement not covered" >    let path = buildPath(resource.path, parameters);</span>
<span class="cstat-no" title="statement not covered" >    return Promise.resolve(new Request(resource.method, path, parameters));</span>
  }
}
&nbsp;
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    CLIENTS.set(this, client);</span>
&nbsp;
    /**
     ...
     * @type {boolean}
     */
<span class="cstat-no" title="statement not covered" >    this.w3c = false;</span>
&nbsp;
    /** @private {Map&lt;string, CommandSpec&gt;} */
<span class="cstat-no" title="statement not covered" >    this.customCommands_ = null;</span>
&nbsp;
    /** @private {!logging.Logger} */
<span class="cstat-no" title="statement not covered" >    this.log_ = logging.getLogger('webdriver.http.Executor');</span>
  }
&nbsp;
  /**
   ...
   */
  defineCommand<span class="fstat-no" title="function not covered" >(name, method, path) {</span>
<span class="cstat-no" title="statement not covered" >    if (!this.customCommands_) {</span>
<span class="cstat-no" title="statement not covered" >      this.customCommands_ = new Map;</span>
    }
<span class="cstat-no" title="statement not covered" >    this.customCommands_.set(name, {method, path});</span>
  }
&nbsp;
  /** @override */
  execute<span class="fstat-no" title="function not covered" >(command) {</span>
<span class="cstat-no" title="statement not covered" >    let request = buildRequest(this.customCommands_, this.w3c, command);</span>
<span class="cstat-no" title="statement not covered" >    return request.then(request =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      this.log_.finer(() =&gt; <span class="cstat-no" title="statement not covered" >`&gt;&gt;&gt; ${request.method} ${request.path}`)</span>;</span>
<span class="cstat-no" title="statement not covered" >      return doSend(this, request).then(response =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        this.log_.finer(() =&gt; <span class="cstat-no" title="statement not covered" >`&gt;&gt;&gt;\n${request}\n&lt;&lt;&lt;\n${response}`)</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        let httpResponse = /** @type {!Response} */(response);</span>
<span class="cstat-no" title="statement not covered" >        let {isW3C, value} = parseHttpResponse(command, httpResponse);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (command.getName() === cmd.Name.NEW_SESSION</span>
            || command.getName() === cmd.Name.DESCRIBE_SESSION) {
<span class="cstat-no" title="statement not covered" >          if (!value || !value.sessionId) {</span>
<span class="cstat-no" title="statement not covered" >            throw new error.WebDriverError(</span>
...
<span class="cstat-no" title="statement not covered" >          if (command.getName() === cmd.Name.NEW_SESSION) {</span>
<span class="cstat-no" title="statement not covered" >            this.w3c = this.w3c || isW3C;</span>
          }
&nbsp;
          // No implementations use the `capabilities` key yet...
<span class="cstat-no" title="statement not covered" >          let capabilities = value.capabilities || value.value;</span>
<span class="cstat-no" title="statement not covered" >          return new Session(value.sessionId, capabilities);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return typeof value === 'undefined' ? null : value;</span>
      });
    });
  }
}
 ...
 * @return {?} .
 */
<span class="fstat-no" title="function not covered" >function tryParse(str) {</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function parseHttpResponse(command, httpResponse) {</span>
<span class="cstat-no" title="statement not covered" >  if (httpResponse.status &lt; 200) {</span>
    // This should never happen, but throw the raw response so users report it.
<span class="cstat-no" title="statement not covered" >    throw new error.WebDriverError(</span>
        `Unexpected HTTP response:\n${httpResponse}`);
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  let parsed = tryParse(httpResponse.body);</span>
<span class="cstat-no" title="statement not covered" >  if (parsed &amp;&amp; typeof parsed === 'object') {</span>
<span class="cstat-no" title="statement not covered" >    let value = parsed.value;</span>
<span class="cstat-no" title="statement not covered" >    let isW3C =</span>
        value !== null &amp;&amp; typeof value === 'object'
            &amp;&amp; typeof parsed.status === 'undefined';
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!isW3C) {</span>
<span class="cstat-no" title="statement not covered" >      error.checkLegacyResponse(parsed);</span>
&nbsp;
      // Adjust legacy new session responses to look like W3C to simplify
      // later processing.
<span class="cstat-no" title="statement not covered" >      if (command.getName() === cmd.Name.NEW_SESSION</span>
          || command.getName() == cmd.Name.DESCRIBE_SESSION) {
<span class="cstat-no" title="statement not covered" >        value = parsed;</span>
      }
&nbsp;
    } else <span class="cstat-no" title="statement not covered" >if (httpResponse.status &gt; 399) {</span>
<span class="cstat-no" title="statement not covered" >      error.throwDecodedError(value);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {isW3C, value};</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (parsed !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >    return {isW3C: false, value: parsed};</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  let value = httpResponse.body.replace(/\r\n/g, '\n');</span>
&nbsp;
  // 404 represents an unknown command; anything else &gt; 399 is a generic unknown
  // error.
<span class="cstat-no" title="statement not covered" >  if (httpResponse.status == 404) {</span>
<span class="cstat-no" title="statement not covered" >    throw new error.UnsupportedOperationError(value);</span>
  } else <span class="cstat-no" title="statement not covered" >if (httpResponse.status &gt;= 400) {</span>
<span class="cstat-no" title="statement not covered" >    throw new error.WebDriverError(value);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return {isW3C: false, value: value || null};</span>
}
&nbsp;
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function buildPath(path, parameters) {</span>
<span class="cstat-no" title="statement not covered" >  let pathParameters = path.match(/\/:(\w+)\b/g);</span>
<span class="cstat-no" title="statement not covered" >  if (pathParameters) {</span>
<span class="cstat-no" title="statement not covered" >    for (let i = 0; i &lt; pathParameters.length; ++i) {</span>
<span class="cstat-no" title="statement not covered" >      let key = pathParameters[i].substring(2); </span> // Trim the /:
<span class="cstat-no" title="statement not covered" >      if (key in parameters) {</span>
<span class="cstat-no" title="statement not covered" >        let value = parameters[key];</span>
<span class="cstat-no" title="statement not covered" >        if (WebElement.isId(value)) {</span>
          // When inserting a WebElement into the URL, only use its ID value,
          // not the full JSON.
<span class="cstat-no" title="statement not covered" >          value = WebElement.extractId(value);</span>
        }
<span class="cstat-no" title="statement not covered" >        path = path.replace(pathParameters[i], '/' + value);</span>
<span class="cstat-no" title="statement not covered" >        delete parameters[key];</span>
      } else {

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/input.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/input.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/</a> &#187; input.js</div>
</div>
<div class="body">
 ...
 */
Key.chord = <span class="fstat-no" title="function not covered" >function(var_args) {</span>
<span class="cstat-no" title="statement not covered" >  return Array.prototype.slice.call(arguments, 0).join('') + Key.NULL;</span>
};
&nbsp;
&nbsp;
/**
...
&nbsp;
   ...
   * @package
   */
  handleFile<span class="fstat-no" title="function not covered" >(driver, path) {</span>
<span class="cstat-no" title="statement not covered" >    return Promise.resolve(path);</span>
  }
}
&nbsp;
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/error.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/error.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/</a> &#187; error.js</div>
</div>
<div class="body">
...
class WebDriverError extends Error {
  ...
  constructor<span class="fstat-no" title="function not covered" >(opt_error) {</span>
<span class="cstat-no" title="statement not covered" >    super(opt_error);</span>
&nbsp;
    /** @override */
...
class UnexpectedAlertOpenError extends WebDriverError {
   ...
   */
  constructor<span class="fstat-no" title="function not covered" >(opt_error, opt_text) {</span>
<span class="cstat-no" title="statement not covered" >    super(opt_error);</span>
&nbsp;
    /** @private {(string|undefined)} */
<span class="cstat-no" title="statement not covered" >    this.text_ = opt_text;</span>
  }
&nbsp;
  /**
   ...
   *     if available.
   */
  getAlertText<span class="fstat-no" title="function not covered" >() {</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function encodeError(err) {</span>
<span class="cstat-no" title="statement not covered" >  let type = WebDriverError;</span>
<span class="cstat-no" title="statement not covered" >  if (err instanceof WebDriverError</span>
      &amp;&amp; TYPE_TO_ERROR_CODE.has(err.constructor)) {
<span class="cstat-no" title="statement not covered" >    type = err.constructor;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  let message = err instanceof Error</span>
      ? err.message
      : err + '';
&nbsp;
<span class="cstat-no" title="statement not covered" >  let code = /** @type {string} */(TYPE_TO_ERROR_CODE.get(type));</span>
<span class="cstat-no" title="statement not covered" >  return {'error': code, 'message': message};</span>
}
&nbsp;
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function checkResponse(data) {</span>
<span class="cstat-no" title="statement not covered" >  if (data &amp;&amp; typeof data.error === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    let ctor = ERROR_CODE_TO_TYPE.get(data.error) || WebDriverError;</span>
<span class="cstat-no" title="statement not covered" >    throw new ctor(data.message);</span>
  }
 ...
 * @see https://w3c.github.io/webdriver/webdriver-spec.html#protocol
 */
<span class="fstat-no" title="function not covered" >function isErrorResponse(data) {</span>
<span class="cstat-no" title="statement not covered" >  return data &amp;&amp; typeof data === 'object' &amp;&amp; typeof data.error === 'string';</span>
}
&nbsp;
/**
 ...
 * @see https://w3c.github.io/webdriver/webdriver-spec.html#protocol
 */
<span class="fstat-no" title="function not covered" >function throwDecodedError(data) {</span>
<span class="cstat-no" title="statement not covered" >  if (isErrorResponse(data)) {</span>
<span class="cstat-no" title="statement not covered" >    let ctor = ERROR_CODE_TO_TYPE.get(data.error) || WebDriverError;</span>
<span class="cstat-no" title="statement not covered" >    throw new ctor(data.message);</span>
  }
<span class="cstat-no" title="statement not covered" >  throw new WebDriverError('Unknown error: ' + JSON.stringify(data));</span>
}
&nbsp;
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function checkLegacyResponse(responseObj) {</span>
  // Handle the legacy Selenium error response format.
<span class="cstat-no" title="statement not covered" >  if (responseObj</span>
      &amp;&amp; typeof responseObj === 'object'
      &amp;&amp; typeof responseObj['status'] === 'number'
      &amp;&amp; responseObj['status'] !== 0) {
<span class="cstat-no" title="statement not covered" >    let status = responseObj['status'];</span>
<span class="cstat-no" title="statement not covered" >    let ctor = LEGACY_ERROR_CODE_TO_TYPE.get(status) || WebDriverError;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let value = responseObj['value'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!value || typeof value !== 'object') {</span>
<span class="cstat-no" title="statement not covered" >      throw new ctor(value + '');</span>
    } else {
<span class="cstat-no" title="statement not covered" >      let message = value['message'] + '';</span>
<span class="cstat-no" title="statement not covered" >      if (ctor !== UnexpectedAlertOpenError) {</span>
<span class="cstat-no" title="statement not covered" >        throw new ctor(message);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      let text = '';</span>
<span class="cstat-no" title="statement not covered" >      if (value['alert'] &amp;&amp; typeof value['alert']['text'] === 'string') {</span>
<span class="cstat-no" title="statement not covered" >        text = value['alert']['text'];</span>
      }
<span class="cstat-no" title="statement not covered" >      throw new UnexpectedAlertOpenError(message, text);</span>
    }
  }
<span class="cstat-no" title="statement not covered" >  return responseObj;</span>
}
&nbsp;
&nbsp;
// PUBLIC API

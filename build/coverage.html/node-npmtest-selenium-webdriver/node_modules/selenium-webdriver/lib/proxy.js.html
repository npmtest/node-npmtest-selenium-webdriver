...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/proxy.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/proxy.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-selenium-webdriver/node_modules/selenium-webdriver/lib/</a> &#187; proxy.js</div>
</div>
<div class="body">
 ...
 */
exports.direct = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return {proxyType: 'direct'};</span>
};
&nbsp;
&nbsp;
/**
 ...
 * @return {!ProxyConfig} A new proxy configuration object.
 */
exports.manual = <span class="fstat-no" title="function not covered" >function(options) {</span>
  // TODO(jleyba): Figure out why the Closure compiler does not think this is
  // a ProxyConfig record without the cast.
<span class="cstat-no" title="statement not covered" >  return /** @type {!ProxyConfig} */({</span>
    proxyType: 'manual',
 ...
 */
exports.socks = <span class="fstat-no" title="function not covered" >function(host, username, password) {</span>
<span class="cstat-no" title="statement not covered" >  return /** @type {!ProxyConfig} */({</span>
    proxyType: 'manual',
    socksProxy: host,
 ...
 * @return {!ProxyConfig} A new proxy configuration object.
 */
exports.pac = <span class="fstat-no" title="function not covered" >function(url) {</span>
 ...
 * @return {!ProxyConfig} A new proxy configuration object.
 */
exports.system = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return {proxyType: 'system'};</span>
};
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
